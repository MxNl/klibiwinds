...
This fake data set also shows the structure, that you need to bring your data into:
 ...
 - one column with the name `climate_model_name` containing an identifier for the climate model. Note: historical (not predicted) data has the value "historical" in this column
